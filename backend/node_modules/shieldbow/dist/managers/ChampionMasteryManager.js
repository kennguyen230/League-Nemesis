...
class ChampionMasteryManager {
    ...
    async fetch(champion, options) {
        ...
        try {
            ...
            const response = await this.client.api.request(`/lol/champion-mastery/v4/champion-masteries/by-puuid/${this.summoner.playerId}/by-champion/${champ.key}`, {
                region: region,
                regional: false,
    ...
    async updateTotalScore() {
        ...
        try {
            const response = await this.client.api.request(`/lol/champion-mastery/v4/scores/by-puuid/${this.summoner.playerId}`, {
                region: this.summoner.region,
                regional: false,
                api: 'CHAMPION_MASTERY',
    ...
    async _fetchRawMasteryData(options, n = 0) {
        ...
        try {
            const response = n < 1
                ? await this.client.api.request(`/lol/champion-mastery/v4/champion-masteries/by-puuid/${this.summoner.playerId}`, {
                    region: this.summoner.region,
                    regional: false,
                    api: 'CHAMPION_MASTERY',
                    method: 'getAllChampionMasteries',
                ...
                : await this.client.api.request(`/lol/champion-mastery/v4/champion-masteries/by-puuid/${this.summoner.playerId}/top?count=${n}`, {
                    region: this.summoner.region,
                    regional: false,
                    api: 'CHAMPION_MASTERY',
