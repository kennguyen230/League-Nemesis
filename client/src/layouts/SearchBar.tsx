    ...
    >
      ...
      {isHomePage && (
        <Button
          ...
          disabled={isLoading}
          className="hidden sm:block bg-[#182B40] font-vollkorn md:flex md:justify-center md:items-center md:w-28 mt-2 drop-shadow-md hover:bg-slate-900/90 dark:bg-[#182B40] dark:hover:bg-slate-900/90"
        >
